...
class QnAReportBottomSheet extends StatefulWidget {
  ...
  /// copyWith method to create a new instance of [QnAReportBottomSheet] with the provided parameters
  /// if the parameter is not provided then the default value is used
  QnAReportBottomSheet copyWith({
    Key? key,
    String? entityId,
  ...
  @override
  State<QnAReportBottomSheet> createState() => _QnAReportBottomSheetState();
}

class _QnAReportBottomSheetState extends State<QnAReportBottomSheet> {
            ...
            if (state is LMFeedReportSubmitFailedState) {
              ...
              LMFeedCore.showSnackBar(
                  ...
                  widget.successMessage ??
                      'Reported! Thanks for making this community a safe place',
                  LMFeedWidgetSource.reportScreen);
            }
          },
  ...
  InkWell _defReasonTile(LMDeleteReasonViewData e) {
    return InkWell(
      onTap: () {
  ...
  LMFeedText _defSubTitle() {
    return LMFeedText(
        text:
            'You can report this ${widget.entityType == postEntityId ? postTitle : commentTitle} to us if you think that it goes against our Community Guidelines. We won’t notify this user that you submitted the report',
        style: const LMFeedTextStyle(
          textStyle: TextStyle(
