...
///
/// {@endtemplate}
class LMFeedQnAPersonalisedScreen extends StatefulWidget {
  const LMFeedQnAPersonalisedScreen({
    super.key,
    this.appBar,
...
class _LMFeedQnAPersonalisedScreenState
    extends State<LMFeedQnAPersonalisedScreen> with WidgetsBindingObserver {
