...
class LMFeedActivityScreenBuilderDelegate extends LMFeedWidgetBuilderDelegate {
  ...
  @override
  Widget topicBarBuilder(LMFeedTopicBar topicBar, {Widget? child}) {
  ...
  @override
  Widget addACommentBuilder(BuildContext context,
      LMFeedAddResponse addACommentWidget, LMPostViewData postViewData,
      {Widget? child}) {
