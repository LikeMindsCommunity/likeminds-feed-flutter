...
/// state from the UI
/// [LMFeedCommentCancelEvent] is used to send the request to the handler
/// {@endtemplate}
void handleCancelCommentEvent(LMFeedCommentCancelEvent event,
        Emitter<LMFeedCommentHandlerState> emit) =>
    emit(LMFeedCommentCanceledState());
